...
const Footer = () => {
  return (
    <footer className="bg-secondary text-secondary-foreground py-8 sm:py-10 md:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">SysDesign.online</h3>
          ...
          <div>
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Курсы</h4>
          ...
          <div>
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Материалы</h4>
            <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
              <li>
          ...
          <div className="col-span-2 md:col-span-1">
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Связаться</h4>
        ...
        <div className="pt-6 sm:pt-8 border-t border-secondary-foreground/20 text-center text-xs sm:text-sm text-secondary-foreground/80">
